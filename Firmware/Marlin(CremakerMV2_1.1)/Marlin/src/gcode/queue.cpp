...
// cremaker
bool GCodeQueue::is_lay1testing = false; 
bool GCodeQueue::is_printing_lay1 = false;
bool GCodeQueue::is_z_home_testing = false;
bool GCodeQueue::is_z_home_protect = true;
bool GCodeQueue::is_othertesting = false; 
