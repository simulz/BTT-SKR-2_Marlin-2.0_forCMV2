...
public:
  ...
  static bool is_lay1testing; //cremaker
  static bool is_printing_lay1; //cremaker
  static bool is_z_home_testing; //cremaker
  static bool is_z_home_protect; //cremaker
  static bool is_othertesting; //cremaker
