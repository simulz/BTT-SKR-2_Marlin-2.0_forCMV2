...
bool Endstops::cremakerInTestProgress = false; //cremaker
...
void Endstops::startCremakerTest()
{
  cremakerInTestProgress = true;
  SERIAL_ECHO("true");
  SERIAL_EOL();
}

void Endstops::finishCremakerTest()
{
  cremakerInTestProgress = false;
  SERIAL_ECHO("false");
  SERIAL_EOL();
}

bool Endstops::getCremakerInTestProgressValue()
{
  return cremakerInTestProgress;
}

bool Endstops::getEnableValue()
{
  return enabled;
}//cremaker
