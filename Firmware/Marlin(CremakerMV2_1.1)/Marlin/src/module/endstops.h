...
class Endstops {
  ...
  private:
    ...
    static bool cremakerInTestProgress;
  ...
  public:
    ...
    static void startCremakerTest(); //cremaker

    static void finishCremakerTest(); //cremaker

    static bool getCremakerInTestProgressValue(); //cremaker

    // get Enabled value
    static bool getEnableValue();
