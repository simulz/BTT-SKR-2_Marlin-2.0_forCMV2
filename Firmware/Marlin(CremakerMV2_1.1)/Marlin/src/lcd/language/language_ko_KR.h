...
namespace Language_ko_KR {
  ...
  PROGMEM Language_Str LANGUAGE                            = _UxGT("한국어");
  ...
  PROGMEM Language_Str MSG_PROGRESS_BAR_TEST               = _UxGT("진행바 테스트");
  ...
  PROGMEM Language_Str MSG_KILL_HOMING_FAILED              = _UxGT("원점 이동 실패, 재부팅 필요");
  PROGMEM Language_Str MSG_HEATING_FAILED_LCD              = _UxGT("가열 불가");                                               // "Heating failed"
  PROGMEM Language_Str MSG_THERMAL_RUNAWAY                 = _UxGT("노즐 열량 공급 한계 초과");
  PROGMEM Language_Str MSG_THERMAL_RUNAWAY_BED             = _UxGT("BED 열량 공급 한계 초과");
  PROGMEM Language_Str MSG_THERMAL_RUNAWAY_CHAMBER         = _UxGT("CHAMBER 열량 공급 한계 초과");
  PROGMEM Language_Str MSG_ENDSTOP_ABORT                   = _UxGT("스위치 중단");
  PROGMEM Language_Str MSG_ERR_MAXTEMP                     = _UxGT("최대 온도 초과");
  PROGMEM Language_Str MSG_ERR_MINTEMP                     = _UxGT("최소 온도 이하");
  PROGMEM Language_Str MSG_HALTED                          = _UxGT("프린터 중단");
  PROGMEM Language_Str MSG_PLEASE_RESET                    = _UxGT("재부팅을 진행하세요.");
  #if PREHEAT_COUNT
  ...
  PROGMEM Language_Str MSG_LCD_PROBING_FAILED              = _UxGT("Z 센서 감지 실패");

  PROGMEM Language_Str MSG_DRIVER_BACKWARD                 = _UxGT(" 드라이버 이상");
  
  PROGMEM Language_Str MSG_TMC_CURRENT                     = _UxGT("드라이버 전류");
  PROGMEM Language_Str MSG_TMC_HOMING_THRS                 = _UxGT("센서리스 원점이동");
}
